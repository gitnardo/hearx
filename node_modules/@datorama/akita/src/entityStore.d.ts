...
import { Constructor, EntityState, EntityUICreateFn, IDS, OrArray, UpdateEntityPredicate, UpdateStateCallback, getEntityType, getIDType } from './types';
...
export declare class EntityStore<S extends EntityState = any, EntityType = getEntityType<S>, IDType = getIDType<S>> extends Store<S> {
     ...
     *
     */
    upsert(ids: OrArray<IDType>, newState: Partial<EntityType> | EntityType | UpdateStateCallback<EntityType> | EntityType[], options?: {
