    ...
    ***************************************************************************** */
    ...
    function addEntities(_a) {
        ...
        try {
            ...
            try {
                if (entities_1_1 && !entities_1_1.done && (_c = entities_1.return))
                    _c.call(entities_1);
            }
            finally {
                if (e_1)
         ...
         */
            function (ids, newState) {
                ...
                try {
                    ...
                    try {
                        if (toArray_1_1 && !toArray_1_1.done && (_a = toArray_1.return))
                            _a.call(toArray_1);
                    }
                    finally {
                        if (e_2)
    ...
    function find(collection, idsOrPredicate, idKey) {
        ...
        if (isFunction(idsOrPredicate)) {
            try {
                ...
                try {
                    if (collection_1_1 && !collection_1_1.done && (_a = collection_1.return))
            ...
            try {
                ...
                try {
                    if (collection_2_1 && !collection_2_1.done && (_b = collection_2.return))
                        _b.call(collection_2);
                }
                finally {
                    if (e_2)
                        throw e_2.error;
    ...
    function distinctUntilArrayItemChanged() {
        return operators.distinctUntilChanged(( /**
    ...
    function arrayFind(idsOrPredicate, idKey) {
         ...
         */function (source) {
            ...
            })), distinctUntilArrayItemChanged(), operators.map(( /**
             * @param {?} value
             * @return {?}
             */function (value) {
         ...
         */
            function (project) {
                 ...
                 */function (state) { return state; }))
                        .pipe(operators.distinctUntilChanged(compareKeys(project)), operators.map(( /**
                 * @param {?} state
                 * @return {?}
                 */function (state) {
     ...
     */ QueryEntity = /** @class */ (function (_super) {
         ...
         */
            function (options) {
                 ...
                 * @param {?} state
                 * @return {?}
                 */function (state) { return state.entities; })).pipe(operators.map(( /**
                 * @return {?}
         ...
         */
            function (ids, project) {
                 ...
                 * @return {?}
                 */function (entities) {
                    return mapSkipUndefined(ids, ( /**
                     * @param {?} id
                     * @return {?}
                     */function (id) { return getEntity(id, project)(entities); }));
         ...
         */
            function (idOrPredicate, project) {
                 ...
                 * @param {?} state
                 * @return {?}
                 */function (state) { return state.entities; })).pipe(operators.map(getEntity(id, project)), operators.distinctUntilChanged());
            };
        /**
         * Get an entity by id
         *
         ...
         */
            function (project) {
                ...
                if (isArray(this.getActive())) {
                    return this.selectActiveId().pipe(operators.switchMap(( /**
                     * @param {?} ids
                     * @return {?}
         ...
         */
            function (action) {
                ...
                return this.store.selectEntityAction$.pipe(operators.filter(( /**
                 * @param {?} ac
                 * @return {?}
                 */function (ac) { return ac.type === action; })), operators.map(( /**
                 * @param {?} action
                 * @return {?}
         ...
         */
            function (mapFn, project) {
                 ...
                 * @param {?} state
                 * @return {?}
                 */function (state) { return ( /** @type {?} */(state.ids)); })).pipe(operators.map(mapFn), operators.distinctUntilChanged(), operators.switchMap(( /**
                 * @param {?} id
                 * @return {?}
    ...
    function persistState(params) {
         ...
         */function (value) {
             ...
             */function (state) { return getValue(state, path); }))
                    .pipe(operators.skip(1), operators.filter(( /**
             * @return {?}
    ...
    var SnapshotManager = /** @class */ (function () {
         ...
         */
            function (stores, options) {
                 ...
                 * @param {?} name
                 * @return {?}
                 */function (name) { return normalizedStores.hasOwnProperty(name); })), operators.take(size))
                        .subscribe(( /**
                 * @param {?} name
                 * @return {?}
                 */function (name) {
                        return __stores__[name]._setState(( /**
                         * @return {?}
    ...
    var PaginatorPlugin = /** @class */ (function (_super) {
         ...
         */
            function (req) {
                ...
                if (this.hasPage(page)) {
                    ...
                    return rxjs.from(req()).pipe(operators.switchMap(( /**
                     * @param {?} config
                     * @return {?}
                     */function (config) {
         ...
         */
            function (page) {
                var _this = this;
                return this.query.selectAll({ asObject: true }).pipe(operators.take(1), operators.map(( /**
                 * @param {?} entities
                 * @return {?}
                 */function (entities) {
                    /** @type {?} */
    ...
    PersistNgFormPlugin = /** @class */ (function (_super) {
         ...
         */
            function () {
                ...
                this.formChanges = this.form.valueChanges.pipe(operators.debounceTime(this.params.debounceTime)).subscribe(( /**
                 * @param {?} value
                 * @return {?}
                 */function (value) {
     ...
     */ EntityDirtyCheckPlugin = /** @class */ (function (_super) {
        ...
        function EntityDirtyCheckPlugin(query, params) {
            ...
            _this.someDirty$ = rxjs.merge(_this.query.select(( /**
             * @param {?} state
             * @return {?}
             */function (state) { return state.entities; })), _this._someDirty.asObservable()).pipe(operators.auditTime(0), operators.map(( /**
             * @return {?}
    ...
    function combineQueries(observables) {
        return ( /** @type {?} */(rxjs.combineLatest(observables).pipe(operators.auditTime(0))));
    }
    ...
    function setLoading(store) {
         ...
         */function (source) {
             ...
             */function () {
                store.setLoading(true);
                return source.pipe(operators.finalize(( /**
                 * @return {?}
